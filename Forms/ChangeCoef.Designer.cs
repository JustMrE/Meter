namespace Meter.Forms
{
    partial class ChangeCoef
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Введите коэффициент счетчика. \r\nКоэффициент это значение на которое \r\nумножается " +
    "разность показаний счетчика.";
            ...
            this.Name = "ChangeCoef";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Изменить коэффициент счетчика";
            this.TopMost = true;
            this.Shown += new System.EventHandler(this.ChangeCoef_Shown);
